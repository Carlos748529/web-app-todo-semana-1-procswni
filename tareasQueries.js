...
// Funcion que ayuda a manejar la respuestas de la base de datos 
 ...
 */
const queryAll = () => {
    // Una promesa es una forma de que siempre se devuelva un resultado al quien llama (sea error o exito)
    // Si la consulta no genera error, entonces resuelve/cumple la promesa con el resultado
    // Si hay algun error entonces rechaza la consulta e imforma la razon 
